/*
  ...
  1. Changes
    - Drop all existing team-related policies
    - Reset RLS settings
    - Create new simplified policies for teams and members
    - Fix permissions for team creation flow
    - Add proper RLS for team members

  2. Security
    - Enable proper team creation
    - Maintain proper access control for team members
    - Fix team member creation during team creation
*/
